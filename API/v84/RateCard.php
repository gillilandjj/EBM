<?php
   ...
   *
   * @return InquireNetworkProductRateCardRequestInfo
   */
  function createRequest() {
    ...
    if (isset($_GET['product'])) {
      ...
      $filename = 'ratecard_'.$product.'.json';
    }
    $additionalNotes = null;

    return new InquireNetworkProductRateCardRequestInfo($product, $additionalNotes);
  }
  ...
  try {
    if (cacheExpired()) {
      $response = $client->InquireNetworkProductRateCard($request);
